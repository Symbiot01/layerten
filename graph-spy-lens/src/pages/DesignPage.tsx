      ...
      <ScrollArea className="h-[calc(100vh-18rem)] mt-6">
        <div className="pr-4 space-y-6 text-sm">
          ...
          <Section title="5. Extraction Versioning" id="versioning">
            <p>Extraction depends on prompt, model version, and schema. Conceptually <code className="bg-muted px-1 rounded">extraction_version = hash(prompt + model + schema)</code>. When extraction logic changes, the pipeline can be re-run from raw events. Checkpointing supports incremental processing.</p>
          </Section>
          ...
          <Section title="8. Claim Deduplication" id="claim-dedup">
          ...
          <Section title="16. Adaptation to Layer10" id="layer10">
            <p>Designed to extend beyond GitHub: Slack (threads, reactions, edits), Email (reply chains, quoted text), Jira/Linear (ticket status, comments, assignments). Cross-platform identity: email ↔ Slack user ↔ Jira user.</p>
          </Section>
